...
public class PagingUtil {
	public static String pagingText(int getStampCnt, int pageSize, int blockPage, int nowPage, String page) {
		String pagingStr = "";
		// 1.전체 페이지 구하기
	...
	public static String pagingBootStrapStyle(int getStampCnt, int pageSize, int blockPage, int nowPage, String page) {
