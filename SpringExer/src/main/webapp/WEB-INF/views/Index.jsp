	...
	<jsp:include page="/WEB-INF/views/templates/Top.jsp" />
		<div class="view">
			...
			<div class="title-wrap">
				<img src="${pageContext.request.contextPath}/images/main/logo.png" width="300px" alt="Some image" />
