...
<div class="container"
	...
	<div class="item">
		...
		<!-- 리뷰 파일 이미지 받아오는 코드  시작-->
			...
			<a target="_top" href="<c:url value="/Review/ForumPost.do"/>">
		...
		<!-- 프사/닉네임/누르면 프로필 나오고 날짜 누르면 리뷰페이지 나오는 부분 코드 시작 -->
				...
				style="text-decoration: none">
							...
							<!-- 이름 -->
								...
								<span style="display: flex">${item.nickName }</span>
								</a>
								<!-- 리뷰에 맞게 리뷰 링크 교체해야함 -->
								<a target="_top" style="text-decoration: none;"
						href="<c:url value="/Review/ForumPost.do"/>"><!-- 상세페이지 -->
								 <span style="margin: 0px">${item.rvDate }</span>
								 </a>
		...
		<!-- 제목과 누르면 리뷰페이지 나오는 부분 코드 시작 -->
			<!-- 리뷰에 맞게 페이지 링크 수정해야 -->
			 <a target="_top" style="text-decoration: none;"
				href="<c:url value="/Review/ForumPost.do"/>">
