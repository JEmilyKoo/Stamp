          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                <div class="card card-small card-post card-post--1">
                  <div class="card-post__image" style="background-image: url('<c:url value="/resources/images/content-management/1.jpeg"/>');">
                    <a href="#" class="card-post__category badge badge-pill badge-dark">Business</a>
                    <div class="card-post__author d-flex">
                      <a href="#" class="card-post__author-avatar card-post__author-avatar--small" style="background-image: url('<c:url value="/resources/images/avatars/0.jpg"/>');">Written by Anna Kunis</a>
                    </div>
                  </div>
                  <div class="card-body">
                    <h5 class="card-title">
                      <a class="text-fiord-blue" href="#">회원정보 불러오기</a>
                    </h5>
              ...
              <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                <div class="card card-small card-post card-post--1">
                  <div class="card-post__image" style="background-image: url('<c:url value="/resources/images/content-management/2.jpeg"/>');">
                    <a href="#" class="card-post__category badge badge-pill badge-info">Travel</a>
                    <div class="card-post__author d-flex">
                      <a href="#" class="card-post__author-avatar card-post__author-avatar--small" style="background-image: url('<c:url value="/resources/images/avatars/1.jpg"/>');">Written by James Jamerson</a>
                    </div>
                  </div>
                  <div class="card-body">
                    <h5 class="card-title">
              ...
              <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                <div class="card card-small card-post card-post--1">
                  <div class="card-post__image" style="background-image: url('<c:url value="/resources/images/content-management/3.jpeg"/>');">
                    <a href="#" class="card-post__category badge badge-pill badge-primary">Technology</a>
                    <div class="card-post__author d-flex">
                      <a href="#" class="card-post__author-avatar card-post__author-avatar--small" style="background-image: url('<c:url value="/resources/images/avatars/2.jpg"/>');">Written by Jimmy Jackson</a>
                    </div>
                  </div>
                  <div class="card-body">
                    <h5 class="card-title">
              ...
              <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                <div class="card card-small card-post card-post--1">
                  <div class="card-post__image" style="background-image: url('<c:url value="/resources/images/content-management/4.jpeg"/>');">
                    <a href="#" class="card-post__category badge badge-pill badge-warning">Technology</a>
                    <div class="card-post__author d-flex">
                      <a href="#" class="card-post__author-avatar card-post__author-avatar--small" style="background-image: url('<c:url value="/resources/images/avatars/3.jpg"/>');">Written by John James</a>
                    </div>
                  </div>
                  <div class="card-body">
                    <h5 class="card-title">
            ...
            <div class="row">
              <div class="col-lg-6 col-sm-12 mb-4">
                <div class="card card-small card-post card-post--aside card-post--1">
                  <div class="card-post__image" style="background-image: url('<c:url value="/resources/images/content-management/5.jpeg"/>');">
                    <a href="#" class="card-post__category badge badge-pill badge-info">Travel</a>
                    <div class="card-post__author d-flex">
                      <a href="#" class="card-post__author-avatar card-post__author-avatar--small" style="background-image: url('<c:url value="/resources/images/avatars/0.jpg"/>');">Written by Anna Ken</a>
                    </div>
                  </div>
                  <div class="card-body">
                    <h5 class="card-title">
              ...
              <div class="col-lg-6 col-sm-12 mb-4">
                <div class="card card-small card-post card-post--aside card-post--1">
                  <div class="card-post__image" style="background-image: url('<c:url value="/resources/images/content-management/6.jpeg"/>');">
                    <a href="#" class="card-post__category badge badge-pill badge-dark">Business</a>
                    <div class="card-post__author d-flex">
                      <a href="#" class="card-post__author-avatar card-post__author-avatar--small" style="background-image: url('<c:url value="/resources/images/avatars/1.jpg"/>');">Written by Jamie James</a>
                    </div>
                  </div>
                  <div class="card-body">
                    <h5 class="card-title">
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="card card-small card-post mb-4">
                  ...
                  <div class="card-footer border-top d-flex">
                    <div class="card-post__author d-flex">
                      <a href="#" class="card-post__author-avatar card-post__author-avatar--small" style="background-image: url('<c:url value="/resources/images/avatars/1.jpg"/>');">Written by James Khan</a>
              ...
              <div class="col-lg-4">
                <div class="card card-small card-post mb-4">
                  ...
                  <div class="card-footer border-top d-flex">
                    <div class="card-post__author d-flex">
                      <a href="#" class="card-post__author-avatar card-post__author-avatar--small" style="background-image: url('<c:url value="/resources/images/avatars/2.jpg"/>');">Written by Anna Kunis</a>
                      <div class="d-flex flex-column justify-content-center ml-3">
              ...
              <div class="col-lg-4">
                <div class="card card-small card-post mb-4">
                  ...
                  <div class="card-footer border-top d-flex">
                    <div class="card-post__author d-flex">
                      <a href="#" class="card-post__author-avatar card-post__author-avatar--small" style="background-image: url('<c:url value="/resources/images/avatars/3.jpg"/>');">Written by Anna Kunis</a>
                      <div class="d-flex flex-column justify-content-center ml-3">
            ...
            <div class="row">
              <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                <div class="card card-small card-post h-100">
                  <div class="card-post__image" style="background-image: url('<c:url value="/resources/images/content-management/7.jpeg"/>');"></div>
                  <div class="card-body">
                    <h5 class="card-title">
              ...
              <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                <div class="card card-small card-post h-100">
                  <div class="card-post__image" style="background-image: url('<c:url value="/resources/images/content-management/8.jpeg"/>');"></div>
                  <div class="card-body">
                    <h5 class="card-title">
              ...
              <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                <div class="card card-small card-post h-100">
                  <div class="card-post__image" style="background-image: url('<c:url value="/resources/images/content-management/9.jpeg"/>');"></div>
                  <div class="card-body">
                    <h5 class="card-title">
              ...
              <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                <div class="card card-small card-post h-100">
                  <div class="card-post__image" style="background-image: url('<c:url value="/resources/images/content-management/10.jpeg"/>');"></div>
                  <div class="card-body">
                    <h5 class="card-title">
