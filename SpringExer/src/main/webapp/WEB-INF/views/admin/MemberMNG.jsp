				...
				<div class="nav-wrapper">
					<ul class="nav flex-column">
						...
						<li class="nav-item"><a class="nav-link "
							href="<c:url value="/Admin/MemberMNG.do"/>"> <i class="material-icons">vertical_split</i>
								<span>회원정보관리</span>
						</a></li>
						<li class="nav-item"><a class="nav-link "
						...
						<li class="nav-item"><a class="nav-link "
							href="<c:url value="/AdminStamp"/>"> <i class="material-icons">view_module</i>
								<span>스탬프관리</span>
						</a></li>
						...
						<li class="nav-item"><a class="nav-link "
							href="<c:url value="/Admin/RiviewMNG.do"/>"> <i class="material-icons">person</i>
								<span>리뷰 관리</span>
						</a></li>
						<li class="nav-item"><a class="nav-link " href="errors.html">
								<i class="material-icons">error</i> <span>리뷰 댓글 관리</span>
						</a></li>
						<li class="nav-item"><a class="nav-link " href="errors.html">
								<i class="material-icons">error</i> <span>댓글 좋아요 관리</span>
						</a></li>
						<li class="nav-item"><a class="nav-link " href="errors.html">
								<i class="material-icons">error</i> <span>리뷰 좋아요 관리</span>
						</a></li>
						<li class="nav-item"><a class="nav-link " href="errors.html">
								<i class="material-icons">error</i> <span>대댓글 관리</span>
						</a></li>
						<li class="nav-item"><a class="nav-link " href="errors.html">
					...
					<nav
						...
						<ul class="navbar-nav border-left flex-row ">
							<li class="nav-item border-right dropdown notifications"><a
								class="nav-link nav-link-icon text-center" href="#"
								...
								<div class="dropdown-menu dropdown-menu-small"
									...
									</a> <a class="dropdown-item notification__all text-center"
							...
							<li class="nav-item dropdown"><a
								...
								aria-haspopup="true" aria-expanded="false"> <img
									...
									src=<c:url value="/resources/images/avatars/0.jpg"/>
          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                <div class="card card-small card-post card-post--1">
                  ...
                  <div class="card-body">
                    <h5 class="card-title">
                      <a class="text-fiord-blue" href="#">회원정보</a>
                    </h5>
			...
			<p class="font_8"
				style="text-align: left; line-height: 1.75em; font-size: 15px">
						<span>   	
				         아이디 :  ${otherProfile.id}<br/>
				         이메일 :  ${otherProfile.mail}<br/>
				         여행 성향 : ${otherProfile.trvprpns}<span><br/></span>
				         PR :  ${otherProfile.pr}<br/>
				         성별 :  ${otherProfile.gender}<br/>
				         생일 :  ${otherProfile.birth}<br/>
				         폰 번호 :  ${otherProfile.phone}<br/>
				         경험치 :  ${otherProfile.exp}<br/>
				         공개 여부 :  ${otherProfile.openprf} </span><br/>
				         프사 :  ${otherProfile.prfImage}<br/> 
					</p>
                  </div>
                </div>
              </div>
			...
			<p class="font_8"
				style="text-align: left; line-height: 1.75em; font-size: 13px">
				<span>   	
			         아이디 :  ${otherProfile.id}
