...
<jsp:include page="/WEB-INF/views/templates/ProfileSideBar2.jsp" />
</div>
...
<h2 class="font_4 color_32"
	...
	<div class=" profileCard3 comp-kpndp2z9 _1rug6 osdAp profileFollow" dir="ltr">
<a href="<c:url value="/Profile/Following.do"/>"><span class="font_9 color_5" style="padding:3px"> <span class="glyphicon glyphicon-ok" aria-hidden="true"></span> 팔로우 하기</span></a>
		...
		<div
			...
			<div style="justify-content: center;">
				<a href="<c:url value="/Profile/Main/NickName.do?nickName=LEE"/>"><span class=" _3AkkR _2_TEk _2xV_H kl2Hr">LEE</span></a>
				<div class="_2XRvR" style="justify-content: center;">
