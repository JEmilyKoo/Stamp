...
<script charset="utf-8"
	src="./stampGO_files/bootstrap-components-common.31a3c3a3.chunk.min.js"></script>
<script charset="utf-8"
	src="./stampGO_files/bootstrap-components-classic.6c2937a5.chunk.min.js"></script>
<script charset="utf-8"
	src="./stampGO_files/Container_RectangleArea.db226d94.chunk.min.js"></script>
<script charset="utf-8"
	src="./stampGO_files/VerticalMenu_VerticalMenuSolidColorSkin.d6fea72a.chunk.min.js"></script>
<script charset="utf-8"
	src="./stampGO_files/LoginSocialBar.1888c30a.chunk.min.js"></script>
<script charset="utf-8"
	src="./stampGO_files/bootstrap-components-responsive.63905f12.chunk.min.js"></script>
<script charset="utf-8"
	src="./stampGO_files/MeshGroup.39bae923.chunk.min.js"></script>
<script charset="utf-8"
	src="./stampGO_files/FreemiumBannerDesktop.d59802f4.chunk.min.js"></script>
<script charset="utf-8"
	src="./stampGO_files/SkipToContentButton.1b978885.chunk.min.js"></script>
<script charset="utf-8"
	src="./stampGO_files/HtmlComponent.fa918050.chunk.min.js"></script>
<script src="./stampGO_files/requirejs.min.js"></script>
<script charset="utf-8" src="./stampGO_files/ItemActions.chunk.min.js"></script>
<script charset="utf-8"
	src="./stampGO_files/proGallery_videoScrollHelper.chunk.min.js"></script>
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/stampGO_files/common-site-members-dialogs.d415cb14.chunk.min.css">
<script charset="utf-8"
	src="./stampGO_files/common-site-members-dialogs.5d3bc72c.chunk.min.js"></script>
<style data-emotion=""></style>
<script charset="utf-8"
	src="./stampGO_files/proGallery_videoItem.chunk.min.js"></script>
<script charset="utf-8"
	src="./stampGO_files/AsyncEventHandler.chunk.min.js"></script>
<script charset="utf-8"
	src="./stampGO_files/proGallery_reactPlayer.chunk.min.js"></script>
<script charset="utf-8" src="./stampGO_files/HlsPlayer.chunk.min.js"></script>
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/stampGO_files/WPhoto_CirclePhoto.00104e81.chunk.min.css">
<script charset="utf-8"
	src="./stampGO_files/WPhoto_CirclePhoto.d52c26c9.chunk.min.js"></script>
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/stampGO_files/post-page-wix-comments.chunk.min.css"
...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/stampGO_files/forum-rce-frameless.chunk.min.css">
<script charset="utf-8"
	src="./stampGO_files/forum-rce-frameless.chunk.min.js"></script>
<script charset="utf-8" src="./stampGO_files/53.chunk.min.js"></script>
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/stampGO_files/member-card-async-frameless.chunk.min.css">
<script charset="utf-8"
	src="./stampGO_files/member-card-async-frameless.chunk.min.js"></script>

<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/categories-manager-modal.chunk.min.css">
<script charset="utf-8"
	src="./stampGO_files/categories-manager-modal.chunk.min.js"></script>
</head>
								...
								<div id="여행리뷰정보아이디" class="확인용2">
									<div class="확인용4">
										<div id="Container여행리뷰정보아이디" class="확인용5">
											<div data-mesh-id="Container여행리뷰정보아이디inlineContent"
												data-testid="inline-content">
												<div
													data-mesh-id="Container여행리뷰정보아이디inlineContent-gridContainer"
																...
																<div class="md lt-lg lt-xl gt-xs gt-sm sidebar-on">
																	<div id="content-wrapper"
																		...
																		<div class="_1MfyE" id="modal-overlay">
																			<div
																				style="z-index: 0; position: absolute; inset: 0px;">
																				<span style="pointer-events: auto;">

																					<main class="_1ghDI _37pY2" data-hook="modal-page"
																						role="dialog" tabindex="0"
																						aria-labelledby="1624438324849">
																						<div>
																						...
																						<div
																							...
																							<div
																								class="VO0cM default-forum-card-background-color">
																								<div role="form"
																									class="m3iAd forum-content-classic-font"
																											...
																											<div class="_2M1V_ _90dl">
																												<div class="_25dL0">
																													...
																													<h3 id="frm-category-setting-form-header"
																														class="_2ylhw forum-title-classic-font">메인
																														페이지 편집</h3>
																												</div>
																												<div class="_3bWcK">
																													<div class="_2-_9a _3E-Mz">
																														<div class="s1OaD">
																															<label class="_3VKv5">게시판 이름</label>
																															<div class="_2olh8"
																																titlefontclassname="forum-title-classic-font"
																																aria-label="짧고 기억하기 좋은 게시판 이름을 추가하세요."
																												...
																												<div class="_3bWcK">
																													<div class="_2-_9a _3E-Mz">
																														<div class="s1OaD">
																															...
																															<div class="_2olh8"
																																titlefontclassname="forum-title-classic-font"
																																aria-label="방문자가 내 커뮤니티의 성격을 파악할 수 있도록 게시판 메인 페이지 제목을 추가하세요."
																																appeardelay="500" direction="ltr">
																																<svg xmlns="http://www.w3.org/2000/svg"
																																	width="24" height="24"
																																	viewBox="0 0 24 24" role="img"
																												...
																												<div class="_3bWcK">
																													<div class="_2-_9a _3E-Mz">
																														<div class="s1OaD">
																															...
																															<div class="_2olh8"
																																titlefontclassname="forum-title-classic-font"
																																aria-label="게시판 설명을 추가하세요. 게시판 홈페이지 입장 시 방문자에게 게시판에서 가능한 활동이 무엇인지 알려주세요."
																																appeardelay="500" direction="ltr">
																																<svg xmlns="http://www.w3.org/2000/svg"
																																	width="24" height="24"
																																	viewBox="0 0 24 24" role="img"
																													...
																													<textarea id="INPUT_ID_DESCRIPTION"
																														...
																														placeholder="게시판 설명을 추가하세요."
																														style="border: 1px solid rgba(0, 0, 0, 0.2); height: 73px;">게시판에서 여행 관련 주제의 글에 참여해보세요.</textarea>
																												</div>
																												<div class="KmwsH _1-BAK"
																													...
																													<div
																														class="_36haM forum-content-classic-font">
																													...
																													<div
																														titlefontclassname="forum-title-classic-font"
																														appeardelay="500" direction="ltr">
																														<button aria-label="커버 이미지 삭제"
																															class="_2gmxH">
																															<svg xmlns="http://www.w3.org/2000/svg"
																																width="24" height="24"
																																viewBox="0 0 24 24" class="KUQFu">
																																<path fill-rule="evenodd"
																									...
																									<div class="_1CqyJ"
																										...
																										<div
																											class="_3Cioj forum-separator-background-color"></div>
																										<div class="VO2IV">
																											<div class="_3-clJ">
																												<button
