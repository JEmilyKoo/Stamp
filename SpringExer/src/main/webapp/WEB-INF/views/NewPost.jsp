																...
																<div class="TPASection_kpndq3bq">
																	<div dir="ltr">
																		<div class="md lt-lg lt-xl gt-xs gt-sm sidebar-on">
																			...
																			<div id="contentWrapper" class="boxSize _3KFQm app-desktop forum-background-color">
																				<div class="_2zoLI" id="modal-overlay"></div>
																				<div>
																					<div class="PfdRR message" data-hook="message"></div>
																				</div>
																				<div data-hook="forum-contentWrapper" id="contentWrapper">
																					<div class="header header-background-color" data-hook="header">
																						<div class="headerBox">
																							<nav aria-label="Breadcrumbs" class="_3xObj forum-content-classic-font breadcrumbs-text-color">
																								<ol class="_18QAN">
																									<li><a href="https://jemilykoo.wixsite.com/website/forum" data-hook="breadcrumbs__1">여행 리뷰/정보</a></li>
																									<span class="_3q5sF"><svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 6 10" style="fill-rule: evenodd;" class="breadcrumbs-icon-fill"><path d="M785.783,854.5l-4.552,4.3a0.771,0.771,0,0,1-1.048,0,0.672,0.672,0,0,1,0-.99L784.21,854l-4.027-3.8a0.672,0.672,0,0,1,0-.99,0.773,0.773,0,0,1,1.048,0l4.552,4.3A0.674,0.674,0,0,1,785.783,854.5Z" transform="translate(-780 -849.031)"></path></svg></span>
																									<li><span tabindex="0" aria-current="page" data-hook="breadcrumbs__current-page" role="link">자유게시판</span></li>
																								</ol>
																							</nav>
																							<div class="_2LHxU">
																									...
																									<div class="_3iW6- search-input">
																										<div class="_2RwOg" role="search" aria-label="&nbsp;" tabindex="0">
																											...
																											<form autocomplete="off">
																												<input data-hook="search-input" class="_1quPh header-search-text-color header-search-font search-input__input" type="text" autocomplete="off" placeholder="&nbsp;"> </form>
																											<div class="_2nmH8 header-search-text-color header-search-font GPrPx">&nbsp;</div>
																											<div class="q4nje header-search-border-background-color"></div><span></span></div>
																									</div>
																								</div>
																								<div class="_3YKCe">
																									<button class="_5UTVV breadcrumbs-icon-fill button-hover-fill" data-hook="categories-manager-button" aria-label="Open categories manager modal">
																										<svg width="19px" height="19px" viewBox="0 0 19 19" version="1.1" xmlns="http://www.w3.org/2000/svg" class="_1pYDZ">
																					...
																					<div class="_1W1_h">
																						<div class="_3IIvE">
																							<div class="_3jp2s default-header-text-color page-description _1iSUx" style="color: rgb(0, 0, 0); height: 300px;">
																								<div class="_3Z0vv" alt="">
																									<div class="LTMVp" style="background-color: rgb(255, 255, 255); opacity: 1;" data-hook="page-cover"></div>
																									<div class="_36G23">
																										<div class="_26TAI">
																											<div class="_2POlQ page-description-title-font page-description__title" data-hook="page-description__title">
																												<h1 tabindex="-1" class="_1_JwX">자유게시판</h1></div>
																											<div class="dTyOb page-description-font" data-hook="page-description__description">
																												<p class="EV-c5" style="-webkit-line-clamp: 10;">자유게시판</p>
																											</div>
																										</div>
																									</div>
																								</div>
																							</div>
																							<div class="_3GQpe forum-content-classic-font forum-card-background-color forum-text-color forum-card-border-color" style="border-width: 1px;">
																								<div class="forum-title-classic-font">
																									<div class="f06c5" data-hook="empty-states__header">게시물을 작성하시겠습니까?</div>
																								</div>
																								<div class="_3ZOpP" data-hook="empty-states__content">첫 카테고리 게시물을 작성해보세요.</div>
																								<div class="_3eHZH" data-hook="empty-states__sign-up">
																									<div class="_1Yie5">
																										<div>
																											<div class="_3-clJ">
																												<button class="rFYrt forum-content-classic-font button-background-color button-primary-text-color nfcGU" data-hook="create-post" actiondetails="[object Object]"><span class="_3LiYl">그룹 대화</span></button>
																											</div>
																										</div>
																									</div>
																								</div>
